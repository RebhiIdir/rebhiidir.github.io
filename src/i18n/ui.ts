...
export const ui = {
  en: {
    ...
    about: {
      ...
      description:
        "Master's student in Intelligent Computer Systems, building a research trajectory around trustworthy and secure generative AI.",
      atAGlance: "At a glance",
      name: "Name",
      location: "Location",
      focus: "Focus",
      focusValue: "Steganalysis, diffusion models, computer vision, trustworthy AI",
      languages: "Languages",
      researchInterests: "Research interests",
    },
    cv: {
  ...
  fr: {
    ...
    about: {
      ...
      description:
        "Étudiant en Master Systèmes Informatiques Intelligents, construisant une trajectoire de recherche autour de l'IA générative sûre et digne de confiance.",
      atAGlance: "En bref",
      name: "Nom",
      location: "Localisation",
      focus: "Domaine",
      focusValue: "Stéganalyse, modèles de diffusion, vision par ordinateur, IA de confiance",
      languages: "Langues",
      researchInterests: "Domaines de recherche",
    },
    cv: {
