...
export const ui = {
  en: {
    ...
    contact: {
      ...
      formDescription: "Prefer a form? Write directly here — it reaches me without showing any email address.",
      formName: "Your name",
      ...
      formError: "Something went wrong. Please try again, or use the email button above.",
    },
    theme: {
  ...
  fr: {
    ...
    contact: {
      ...
      formDescription: "Vous préférez un formulaire ? Écrivez directement ici — le message m'arrive sans afficher d'adresse e-mail.",
      formName: "Votre nom",
      ...
      formError: "Une erreur est survenue. Réessayez, ou utilisez le bouton e-mail ci-dessus.",
    },
    theme: {
